...
public class ApptTest {
    ...
    **/
	...
	public void test07() throws Throwable {
		...
		//assertions
		assertTrue(apptDup1.getValid());
		assertTrue(apptDup2.getValid());
		assertEquals(apptDup1.getStartHour(), apptDup2.getStartHour());
		assertEquals(apptDup1.getStartMinute(), apptDup2.getStartMinute());
		assertEquals(apptDup1.getStartDay(), apptDup2.getStartDay());
		assertEquals(apptDup1.getStartMonth(), apptDup2.getStartMonth());
		assertEquals(apptDup1.getStartYear(), apptDup2.getStartYear());
		assertEquals(apptDup1.getTitle(), apptDup2.getTitle());
		assertEquals(apptDup1.getDescription(), apptDup2.getDescription());  
	}
}